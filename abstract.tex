...
One reason is that a collection vehicle driving from one heavily filled 
container to another one needs more time than a vehicle following a fixed plan, 
when the heavily filled containers are positioned far apart from each other. 
